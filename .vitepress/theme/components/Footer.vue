  ...
  <footer id="main-footer" class="main-footer">
    <div class="footer-content">
      ...
      <div class="meta">
        ...
        <a class="theme link" href="https://github.com/Xiximei36/vitepress-theme-curve" target="_blank">
          <span class="name">主题</span>
        </a>
        <a class="rss link" href="https://blog.xiximei.us.kg/rss.xml" target="_blank">
